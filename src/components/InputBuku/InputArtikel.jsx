...
import ModalInputJurnal from './ModalInputJurnal';
...
const InputLaporan = ({ jenis: jenisBuku }) => {
  ...
  const [openModalJurnal, setOpenModalJurnal] = useState(false);
  ...
  const handleSubmitEnd = (values) => {
    const url = process.env.REACT_APP_URL + '/api/karya_tulis';
    let body = JSON.stringify({
      ...
      id_paper : parseInt(values.id_paper)
    });
  ...
  const fillPaperID = (paperId) => {
    console.log(paperId)
    formik.setFieldValue('id_paper', paperId);
    setOpenModalJurnal(false);
  };
  ...
  return (
    <React.Fragment>
      ...
      <form className="form-buku">
        ...
        <TextField
          className="form-input__field"
          value={formik.values?.penulis}
          label="Penulis"
          name="penulis"
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
          error={formik.errors?.penulis && formik.touched?.penulis}
          helperText={
            formik.errors?.penulis && formik.touched?.penulis
              ? formik.errors?.penulis
              : null
          }
        ></TextField>
        <TextField
          ...
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
          error={formik.errors?.tahun && formik.touched?.tahun}
          helperText={
        ...
        <TextField
          ...
          onBlur={formik.handleBlur}
          error={formik.errors?.id_paper && formik.touched?.id_paper}
          helperText={
            formik.errors?.id_paper && formik.touched?.id_paper
              ? formik.errors?.id_paper
              : null
          }
        ></TextField>
        <ModalMahasiswa
        ...
        />
        <ModalJurnal
          handleClick={fillPaperID}
          jenis={jenisBuku}
          open={openModalJurnal}
          handleClose={() => {
            setOpenModalJurnal(false);
          }}
        />
...
const ModalJurnal = (props) => {
  ...
  return (
    <Modal open={props.open} onClose={props.handleClose}>
      <Box sx={style}>
        <ModalInputJurnal handleClick={props.handleClick} jenis={props.jenis}></ModalInputJurnal>
      </Box>
    </Modal>
  );
};
